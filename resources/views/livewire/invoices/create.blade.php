<div class="max-w-3xl mx-auto">
    <div class="mb-8">
        ...
        <p class="text-slate-400 mt-1">Generate payment request for client.</p>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input wire:model="invoice_number" type="text" placeholder="INV-XXXX-XXX"
                            class="w-full bg-slate-800/50 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all font-mono tracking-wide">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input wire:model="amount" type="number" placeholder="0"
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <label class="cursor-pointer">
                        ...
                        <div
                            ...
                            <div class="text-[10px] opacity-60">Fully Paid</div>
                        </div>
                    </label>
                    ...
                    <label class="cursor-pointer">
                        ...
                        <div
                            ...
                            <div class="text-[10px] opacity-60">Active/Unpaid</div>
                        </div>
                    </label>
                    ...
                    <label class="cursor-pointer">
                        ...
                        <div
                            ...
                            <div class="text-[10px] opacity-60">Save only</div>
                        </div>
                    </label>
